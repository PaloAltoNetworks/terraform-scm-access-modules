...
curl -sL https://github.com/terraform-docs/terraform-docs/releases/download/v0.17.0/terraform-docs-v0.17.0-linux-amd64.tar.gz > terraform-docs.tar.gz    & \
curl -sL https://github.com/tfsec/tfsec/releases/download/v1.28.5/tfsec-linux-amd64 > tfsec    & \
curl -sL https://github.com/terraform-linters/tflint/releases/download/v0.50.1/tflint_linux_amd64.zip > tflint.zip & \
wait
